        ...
        <div class="max-w-[95%] mx-auto px-4 shadow-sm">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4 text-sm font-medium">
                    ...
                    <a href="{{ route('dashboard') }}" class="text-emerald-100 hover:text-white transition flex items-center gap-1">
            ...
            <div class="block md:hidden space-y-4 p-4 bg-gray-50/50">
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-200 space-y-3 shadow-xs">
                    ...
                    <div class="pt-2 border-t border-gray-100 flex justify-end gap-2">
                        ...
                        @if(auth()->user()->rol === 'administrador')
                        <button onclick="toggleModal('modal-{{ $reporte->recepcion_id }}')" class="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white text-xs px-4 py-2 rounded-lg font-medium transition text-center">
