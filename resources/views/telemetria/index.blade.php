                ...
                <table class="w-full text-left border-collapse whitespace-nowrap text-xs">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="py-3 px-4 font-bold text-emerald-700 text-sm">{{ $reg->ph_valor ?? '--' }}</td>
                            <td class="py-3 px-4 font-bold text-blue-700 text-sm">{{ $reg->tds_valor ?? '--' }} mS/cm</td>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse whitespace-nowrap text-xs">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="py-3.5 px-4 font-bold text-cyan-700">{{ $reg->peso_bascula_1 !== null ? $reg->peso_bascula_1 . ' g' : '--' }}</td>
                            <td class="py-3.5 px-4 font-bold text-cyan-700">{{ $reg->peso_bascula_2 !== null ? $reg->peso_bascula_2 . ' g' : '--' }}</td>
                            ...
                            <td class="py-3.5 px-4">{{ $reg->calidad_aire_eco2 ?? '--' }} ppm</td>
